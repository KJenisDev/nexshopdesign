...
public class AKMonthYearPickerView: UIView {
    ...
    public  var previousYear        = 0
    public  var NextYear        = 20
    
    
    public static var sharedInstance   = {
        return AKMonthYearPickerView(frame: CGRect(origin: CGPoint(x: 0, y: (AKMonthYearPickerConstants.AppFrameSettings.screenHeight - 216) / 1), size: CGSize(width: AKMonthYearPickerConstants.AppFrameSettings.screenWidth, height: 216)))
    }()
    ...
    override init(frame: CGRect) {
        ...
        monthYearPickerView?.NextYear = NextYear
    ...
    private func getToolBar() -> UIToolbar {
        ...
        let customToolbar          = UIToolbar(frame: CGRect(origin: CGPoint(x: 0, y: (AKMonthYearPickerConstants.AppFrameSettings.screenHeight - 216) / 1), size: CGSize(width: AKMonthYearPickerConstants.AppFrameSettings.screenWidth, height: 40)))
...
private class MonthYearPickerView: UIPickerView, UIPickerViewDelegate, UIPickerViewDataSource {
    ...
    static var sharedInstance   = {
        return MonthYearPickerView(frame: CGRect(origin: CGPoint(x: 0, y: (AKMonthYearPickerConstants.AppFrameSettings.screenHeight) / 1), size: CGSize(width: AKMonthYearPickerConstants.AppFrameSettings.screenWidth, height: 20)))
    }()
